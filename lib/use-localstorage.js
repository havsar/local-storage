...
function useLocalStorage(key, defaultValue) {
    ...
    var _a = (0, react_1.useState)(storage_1.storage.getItem(key) === null
        ? defaultValue
    ...
    var writeState = (0, react_1.useCallback)(function (value) { return (0, local_storage_events_1.writeStorage)(key, value); }, [key]);
    var deleteState = (0, react_1.useCallback)(function () { return (0, local_storage_events_1.deleteFromStorage)(key); }, [key]);
